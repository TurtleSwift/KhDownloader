...
**KhDownloader** is a simple app for downloading albums from [khinsider](https://downloads.khinsider.com/). Works on Windows, Linux, and macOS. Binaries are provided for x64 architectures (you can build for ARM64 yourself). No dependencies required — the program runs from a single binary.
